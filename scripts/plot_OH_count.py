...
from ga_analysis.OH_analyzer import count_oh_and_hbonds_in_database
...
set_default_params()
#path = '/home/hero/data/final_data_base/end_04_04_1'
...
df_counts = pl.read_csv('../output/oh_hbond_counts.csv')



fig, ax = plt.subplots(figsize = (7,4))

for i in ["n_Hbond","n_OH"]:
    H_bonds = df_counts[i].to_numpy()
    coverage = np.matmul(P.T,H_bonds).T/np.square(8)
    ax.plot(U,coverage,lw=2, label=i)
